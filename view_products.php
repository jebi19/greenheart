...
// Query to select all products including the image column
$sql = "SELECT productName, quantity, price, category, image FROM products"; // 'products' is your table name
...
$sql = "SELECT * FROM products"; // 'products' is your table name
$result = $conn->query($sql);
...
if ($result->num_rows > 0) {
    echo "<table>";
    echo "<tr><th>Product Name</th><th>Quantity(Kg)</th><th>Price(Rs)</th><th>Category</th><th>Image</th></tr>";
    
    // Output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["productName"]. "</td><td>" . $row["quantity"]. "</td><td>" . $row["price"]. "</td><td>" . $row["category"]. "</td><td><img src='" . $row["image_path"] . "' class='product-image' alt='" . $row["productName"] . "'></td></tr>";
    }
