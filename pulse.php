...
// Query to select only products with category 'Pulses'
$sql = "SELECT id, productName, quantity, price, image_path FROM products WHERE category = 'Pulses'";
...
<head>
    ...
    <title>View Products - Pulses</title>
...
<body>
    ...
    <script>
     ...
     <script>
        ...
        consoleText(['Top Picks.', 'PULSES.', 'Made with Love❤.'], 'text',['black','maroon','white']);
