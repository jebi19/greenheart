...
// Query to select products where 'sell_to' is 'Dealer'
$sql = "SELECT id, productName, quantity, price, sell_to FROM products WHERE sell_to = 'Dealers'";
    ...
    <header class="header">
        ...
        <div class="menu-container">
            ...
            <div class="dropdown-menu" id="dropdownMenu">
                <a href="dashboard.html"><i class="fas fa-house"></i>&nbsp;Home Page</a>
