...
// Query to select only products with category 'Vegetables'
$sql = "SELECT id, productName, quantity, price, image_path FROM products WHERE category = 'Grains'";
...
<body>
    ...
    <script>
        ...
        consoleText(['Top Picks.', 'GRAINS.', 'Made with Love❤.'], 'text',['black','maroon','white']);
