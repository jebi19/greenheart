...
// Query to select products where 'sell_to' is 'Supermarket'
$sql = "SELECT id, productName, quantity, price, sell_to FROM products WHERE sell_to = 'Supermarket'";
...
<body>
    ...
    <!-- Main Content -->
    <div class="box">
        <h2>Supermarket Products List</h2>
        <?php
